...
const translations = {
  es: {
    ...
    solutionCard2Text: "每一公里都回到社区——整条文化路线被 token 化为一个"路线 NFT"，收入自动拆分。",
    solutionCard3Title: "沿线文化记忆数字档案馆",
    solutionCard3Text: "让长者成为路线的永恒讲述者——"叙事长椅"记录每一段路的故事。",
    solutionCard4Title: "路线级环境数字孪生",
    solutionCard4Text: "看见路的呼吸——为文化路线建立环境仪表板，实时监测路线健康状态。",
