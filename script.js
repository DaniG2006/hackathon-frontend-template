...
const translations = {
  es: {
    ...
    solutionCard1Text: "让路"自己讲故事"——基于位置的AR音频触发，替代视觉标记。以Coyotes路线为原型的线性导航，自动触发空间音频叙事。",
    solutionCard1Tech: "AR.js + 地理围栏 + 空间音频 + 可穿戴触觉手环",
    solutionCard1Feature: "轮椅使用者获得"可通行路段"实时提示，视障者全程依赖音频与振动导航。",
    solutionCard1Carbon: "每完成1km，APP语音播报碳足迹对比和树木吸收量。"
  ...
  en: {
    ...
    solutionCard1Title: "Continuous Immersive Cultural Route Navigation",
    solutionCard1Text: "Let the route "tell its own story" — location-based AR audio triggers replace visual markers. Linear navigation based on Coyotes route prototype, automatically triggering spatial audio narratives.",
